    ...
    std::vector<raw_buffer> & out_files)
{
    ...
    llama_params["guardrail_refusal"] = chat_params.guardrail_refusal;
    if (!chat_params.guardrail_message.empty()) {
        llama_params["guardrail_message"] = chat_params.guardrail_message;
    }
